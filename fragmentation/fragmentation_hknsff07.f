...
C READ GRID DATA AND CALCULATE SPLINE COEFFICIENTS. 
      IF(ISET.EQ.1) THEN
        OPEN(UNIT=IFILE,FILE='fragdata/hkns/hkns_pilo.grd', 
     +      STATUS='OLD')
        OPEN(UNIT=IFILE+1,FILE='fragdata/hkns/gradpilo.grd',
     +      STATUS='OLD')
        NPAR=14

      ELSE IF(ISET.EQ.2) THEN
        OPEN(UNIT=IFILE,FILE='fragdata/hkns/hkns_pinlo.grd',
     +      STATUS='OLD')
        OPEN(UNIT=IFILE+1,FILE='fragdata/hkns/gradpinlo.grd',
     +      STATUS='OLD')
        NPAR=14

      ELSE IF(ISET.EQ.3) THEN
        OPEN(UNIT=IFILE,FILE='fragdata/hkns/hkns_klo.grd',STATUS='OLD')
        OPEN(UNIT=IFILE+1,FILE='fragdata/hkns/gradklo.grd',STATUS='OLD')
        NPAR=17

      ELSE IF(ISET.EQ.4) THEN
        OPEN(UNIT=IFILE,FILE='fragdata/hkns/hkns_knlo.grd',STATUS='OLD')
       OPEN(UNIT=IFILE+1,FILE='fragdata/hkns/gradknlo.grd',STATUS='OLD')
        NPAR=17

      ELSE IF(ISET.EQ.5) THEN
        OPEN(UNIT=IFILE,FILE='fragdata/hkns/hkns_plo.grd',STATUS='OLD')
       OPEN(UNIT=IFILE+1,FILE='fragdata/hkns/gradplo.grd',STATUS='OLD')
        NPAR=13

      ELSE IF(ISET.EQ.6) THEN
        OPEN(UNIT=IFILE,FILE='fragdata/hkns/hkns_pnlo.grd',STATUS='OLD')
       OPEN(UNIT=IFILE+1,FILE='fragdata/hkns/gradpnlo.grd',STATUS='OLD')
        NPAR=13
