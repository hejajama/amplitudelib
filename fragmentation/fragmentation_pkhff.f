...
***********************************************************************
      ...
      SUBROUTINE PKHFF(ISET,ICHARGE,Z,Q2,uff,dff,sff,cff,bff,gff,IFINI)
...
*      COMMON / FRAGINI / IFINI       commented out by H.M.
...
*    SELECTION AND READING OF THE GRID :
      ...
      IF (ISET.EQ.1) THEN
       IIREAD=11       
       OPEN(IIREAD,FILE='fragdata/plo.grid')
      ELSEIF (ISET.EQ.2) THEN
       IIREAD=12
       OPEN(IIREAD,FILE='fragdata/pnlo.grid')
       ELSEIF (ISET.EQ.3) THEN
       IIREAD=13
       OPEN(IIREAD,FILE='fragdata/klo.grid')
      ELSEIF (ISET.EQ.4) THEN
       IIREAD=14
       OPEN(IIREAD,FILE='fragdata/knlo.grid')
      ELSEIF (ISET.EQ.5) THEN
       IIREAD=15
       OPEN(IIREAD,FILE='fragdata/hlo.grid')
      ELSEIF (ISET.EQ.6) THEN
       IIREAD=16
       OPEN(IIREAD,FILE='fragdata/hnlo.grid')
